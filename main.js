document.addEventListener('DOMContentLoaded', function () {
  ...
  //begin 屏幕长度缩减修复 (
  const $hopelight_menu_music_playerBt = document.querySelector('#hopelight_menu_music_player')
  let hopelight_menu_music_playerBtWidth = $hopelight_menu_music_playerBt && $hopelight_menu_music_playerBt.offsetWidth
  //end
